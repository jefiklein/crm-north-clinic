...
// Mapping from simple keys (stored in icon_key) to Lucide React component (copied from Sidebar)
const iconMap: { [key: string]: React.ElementType } = {
  'users': Users, 'calendar-check': CalendarCheck, 'chart-line': LineChart, 'message-square': MessageSquare, 'circle': Circle, 'settings': Settings, 'file-text': FileText, 'dollar-sign': DollarSign, 'briefcase': Briefcase, 'clipboard-list': ClipboardList, 'bell': Bell, 'chart-bar': BarChart2, 'credit-card': CreditCard, 'package': Package, 'shopping-cart': ShoppingCart, 'tag': TagIcon, 'truck': Truck, 'map-pin': MapPin, 'phone': Phone, 'mail': Mail, 'globe': Globe, 'home': Home, 'info': Info, 'help-circle': HelpCircle, 'book': Book, 'folder': Folder, 'database': Database, 'server': Server, 'cloud': Cloud, 'code': Code, 'terminal': Terminal, 'layers': Layers, 'grid': Grid, 'list': List, 'table': Table2, 'calendar': Calendar, 'clock': Clock, 'map': Map, 'compass': Compass, 'target': Target, 'award': AwardIconLucide, 'gift': Gift, 'heart': HeartIcon, 'star': StarIcon, 'sun': SunIcon, 'moon': MoonIcon, 'cloud-rain': CloudRain, 'zap': Zap, 'coffee': CoffeeIcon, 'feather': Feather, 'anchor': Anchor, 'at': AtSign, 'battery-charging': BatteryCharging, 'bell-ring': BellRing, 'bookmark': Bookmark, 'box': Box, 'camera': Camera, 'car': Car, 'cast': Cast, 'check-circle': CheckCircle2, 'chevron-down': ChevronDown, 'chevron-left': ChevronLeft, 'chevron-right': ChevronRight, 'chevron-up': ChevronUp, 'chrome': Chrome, 'circle-dollar-sign': CircleDollarSign, 'circle-help': CircleHelp, 'circle-minus': CircleMinus, 'circle-plus': CirclePlus, 'clock-4': Clock4, 'cloud-drizzle': CloudDrizzle, 'cloud-fog': CloudFog, 'cloud-hail': CloudHail, 'cloud-lightning': CloudLightning, 'cloud-snow': CloudSnow, 'cloud-sun': CloudSun, 'code-2': Code2, 'codesandbox': Codesandbox, 'command': Command, 'download': Download, 'dribbble': Dribbble, 'droplet': Droplet, 'edit': Edit, 'external-link': ExternalLink, 'eye': Eye, 'facebook': Facebook, 'figma': Figma, 'file': File, 'file-archive': FileArchive, 'file-audio': FileAudio, 'file-code': FileCode, 'file-heart': FileHeart, 'file-image': FileImage, 'file-json': FileJson, 'file-key': FileKey, 'file-minus': FileMinus, 'file-music': FileMusic, 'file-output': FileOutput, 'file-plus': FilePlus, 'file-question': FileQuestion, 'file-search': FileSearch, 'file-spreadsheet': FileSpreadsheet, 'file-stack': FileStack, 'file-symlink': FileSymlink, 'file-terminal': FileTerminal, FileType, FileUp, FileVideo, FileWarning, FileX, Filter, Flag, FolderArchive, FolderDot, FolderGit2, FolderGit, FolderOpen, FolderRoot, FolderSearch, FolderSymlink, FolderTree, Frown, Gamepad2, Gauge, Gem, Github, Gitlab, GraduationCap, Handshake, HardDrive, Hash, Headphones, Image, Inbox, InfoIcon, Instagram, Key, Keyboard, Lamp, Laptop, LifeBuoy, Lightbulb, Link2, Linkedin, ListIcon, Loader, Lock, LogIn, LogOut, MailIcon, MapIcon, Maximize, Megaphone, Menu, MessageCircle, MessageSquareIcon, Mic, Minimize, Monitor, MoreHorizontal, MoreVertical, Mountain, Mouse, Music, Navigation, Newspaper, Octagon, Package2, PackageIcon, Paperclip, Pause, PenTool, Percent, PhoneCall, PhoneForwarded, PhoneIncoming, PhoneMissed, PhoneOff, PhoneOutgoing, PhoneOutgoingIcon, PictureInPicture, PieChart, Pin, Play, Plus, Pocket, Power, Printer, Puzzle, QrCode, Radio, Receipt, RectangleHorizontal, RectangleVertical, Redo, RefreshCcw, Repeat, Rocket, Rss, Save, Scale, Scan, Scissors, Search, Send, ServerIcon, SettingsIcon, Share, Shield, ShoppingBag, ShoppingCartIcon, Shuffle, SidebarClose, SidebarOpen, Sigma, Siren, SkipBack, SkipForward, Slack, Slash, SlidersHorizontal, SlidersVertical, Smile, Snowflake, SortAsc, SortDesc, Speaker, Square, Sticker, StopCircle, Store, Sunrise, Sunset, TableIcon, Thermometer, ThumbsDown, ThumbsUp, Ticket, Timer, ToggleLeft, ToggleRight, Tornado, Train, Trash, Trello, TrendingDown, TrendingUp, Triangle, TriangleAlertIcon, TruckIcon, Tv, Twitch, Twitter, Type, Umbrella, Underline, Undo, Unlock, Upload, UploadCloud, User, Utensils, Verified, Video, VideoOff, View, Voicemail, Volume, Volume1, Volume2, VolumeX, Wallet, Wand2, Watch, Waves, Webcam, Wifi, WifiOff, Wind, X, Youtube, ZapIcon, ZoomIn, ZoomOut, MailOpen, Smartphone, MessagesSquare, BadgeDollarSign
};
