...
import TrackeamentoPage from "./pages/TrackeamentoPage"; // Import the new page
        ...
        <Routes>
          ...
          {session && clinicData && clinicData.id ? (
            ...
            >
              ...
              <Route path="16" element={<TrackeamentoPage clinicData={clinicData} />} /> {/* New route for TrackeamentoPage */}
